                ...
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <>
                      ...
                      >
                        by{" "}
                        {product.company.cname.charAt(0).toUpperCase() +
                          product.company.cname.slice(1)}
                      </Link>
                    </>
                  ...
                  <div className="text-right">
                    <p className="text-sm text-green-600 mt-1">
                      {product.stock + " left in stock" || "out of stock"}
                    </p>
                  </div>
                </div>
        ...
        : "bg-amber-600 text-white hover:bg-amber-700 hover:shadow-lg"
          ...
          <div className="mt-8 bg-white rounded-xl shadow-sm overflow-hidden">
            <div className="p-4 md:p-6">
              ...
              <h2 className="text-xl pt-10 font-bold text-gray-900">
                Customer Reviews
              </h2>
                  ...
                  {product.reviews.map((review: any) => (
                    ...
                    >
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between">
                        ...
                        {review.sentiment && (
                          <span
                            className={`mt-2 sm:mt-0 px-2 py-1 text-xs font-medium rounded-full ${
                        ...
                        <div className="flex justify-between items-center">
                          <p className="text-sm sm:text-sm font-light text-gray-900 flex flex-col">
                            {similarProduct.discountedPrice ? (
                              ...
                              <span>
                                {formatCurrency(
                                  convertPrice(similarProduct.price, currency),
                                  currency
                                )}
                              </span>
                            )}
