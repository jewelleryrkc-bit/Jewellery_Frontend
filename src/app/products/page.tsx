  ...
  return (
    <div className="bg-gray-50">
      ...
      <main className="px-4 sm:px-6 pb-12 max-w-7xl mx-auto">
        ...
        {!isSearching && (
          <div>
            <h2 className="text-xl font-light text-gray-800 mb-6 tracking-tight text-center">
              Our recently added
            </h2>
          </div>
        )}
          ...
          <div className="text-center py-12">
            ...
            {searchQuery && (
              <div className="mt-6">
                <Link
                  href="/products"
                  className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-light rounded-md shadow-sm text-white bg-gray-800 hover:bg-gray-700"
                >
                  View All Products
                </Link>
              </div>
