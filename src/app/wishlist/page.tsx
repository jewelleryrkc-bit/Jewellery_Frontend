...
import { REMOVE_WISHLIST_ITEM } from "../../graphql/mutations";
...
export default function Wishlist() {
  ...
  // Mutation to remove wishlist item
  const [removeWishlistItem] = useMutation(REMOVE_WISHLIST_ITEM, {
    refetchQueries: [{ query: GET_WISHLISTS }], // Refresh wishlist after removal
  });
  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 className="text-3xl font-bold text-center text-gray-900 mb-8 border-b pb-4">
          Saved Products
        </h1>
        ...
        {wishproducts.length === 0 ? (
          <div className="text-center py-12">
            ...
            <h3 className="mt-2 text-lg font-medium text-gray-900">
              You didn&apos;t save any product yet
            </h3>
            <p className="mt-1 text-gray-500">
              Start adding some products to your saved product lists.
            </p>
            <div className="mt-6">
              <Link href="/products">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      >
                        ...
                        item.product.images.length > 0 ? (
                          <Image
                            src={item.product.images[0].url} // first image of the product
